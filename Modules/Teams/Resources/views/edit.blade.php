...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="{{route('teams.index')}}">{{trans($model.'::menu.sidebar.main')}}</a></li>
...
<section class="content">
  <div class="box box-success">
    ...
    {!! Form::model($data, ['method' => 'PATCH','route' => ['teams.update', $data->id],'class'=>'form-horizontal validate','id'=>'validateForm']) !!}
    {{ Form::hidden('id',null, []) }}
    <div class="box-body">
      <div class="row">
        <div class="col-md-12">
    ...
    <div class="box-footer">
      <div class="row pull-right">
        <div class="col-sm-12">
          ...
          <a href="{{route('teams.index')}}" class="btn btn-default">{{trans('menu.sidebar.cancel')}}</a>
        </div>
      </div>
    </div>
    {!! Form::close() !!}
