                     ...
                     <div class="inner_content w-100">
                        <div class="profile-setup">
                           ...
                           <div id="profile" class="tabcontent">
                              {!! Form::model(Auth::user(),['method'=>'post', 'route' => ['agent.dashboard.updateProfile'], 'class'=>'editProfile','id'=>'F_edit_user']) !!}
                                    ...
                                    <div class="logo dashboard-user-img">
                                       <div class="avatar avatar-cover">
                                          ...
                                          <div class="upload-btn-wrapper">
                                             ...
                                             <input type="file" id="UImage" name="UImage" accept="image/*" class="onlyimageupload" data-uploadurl="{{route('agent.dashboard.uploadProfile')}}" data-userid="{{auth()->user()->id}}">
                                          </div>
                                       </div>
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-sm-6">
                                    <div class="form-group ermsg">
                                       {{ Form::text('agent_code',null, ['required','class'=>'form-control','placeholder'=>'Agent Code','title'=>'Please enter agent code.','disabled','autocomplete'=>'off']) }}
                                    </div>
                                 </div>
                           ...
                           <div id="password" class="tabcontent">
                              <div class="selected fadeInUp animated2 delay1">
                                 {!! Form::open(['method'=>'post', 'route' => ['agent.dashboard.updatePassword'],'id'=>'F_changePassword','autocomplete'=>'off']) !!}
                           ...
                           <div id="bankdetails" class="tabcontent">
                              <div class="selected fadeInUp animated2 delay1">
                                 {!! Form::model(auth()->user()->userBankDetail,['method'=>'post', 'route' => ['agent.dashboard.updateBankDetails'],'id'=>'F_updateBankDetails','autocomplete'=>'off']) !!}
                                 <div class="row">
                                    <div class="col-sm-6">
                                       <div class="form-group ermsg">
                                          <div class="logo dashboard-user-img">
                                             <div class="avatar avatar-cover">
                                                <img src="{{auth()->user()->UserQRCodeImage}}" alt="qrimg" id="v_qr_code_image" onerror="this.src='{{auth()->user()->ErrorPicturePath}}'" />
                                                <div class="upload-btn-wrapper">
                                                   <button class="btn">
                                                      <i class="ri-upload-line"></i>
                                                   </button>
                                                   <input type="file" id="qr_code_image" name="upi_qr_code_image_file" accept="image/*" class="onlyimageupload" data-uploadurl="{{route('agent.dashboard.uploadBankImages')}}" required>
                                                   {{ Form::hidden('upi_qr_code_image',null, ['id'=>'f_qr_code_image']) }}
                                                </div>
                                             </div>
                                             <p class="upload-txt mt-4">Upload UPI QR Code</p>
                                          </div>
                                       </div>

                                       <div class="form-group ermsg">
                                          {{ Form::text('upi_id',null, ['required','class'=>'form-control','id'=>'upi_id','placeholder'=>'UPI ID','title'=>'Please enter UPI ID','autocomplete'=>'off']) }}
                                       </div>
...
@include('agent::frontend.delete_account_model')
@endsection