            ...
            <div class="header-left">
              <div class="bravo-menu">
                 <ul class="main-menu menu-generated">
                    ...
                    <li class=" depth-0">
                       <a href="mailto:{!! $configVariables['adminemail']['value'] !!}" class="border-0">
                        ...
                        <li class="depth-0">
                            <div class="dropdown afterloginMenu ml-3 position-relative ">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                    ...
                                    @endif
                                    <a class="dropdown-item" href="javascript:;" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" > @lang('menu.logout') <form id="logout-form" action="{{ route('agent.logout') }}" method="POST" style="display: none;">@csrf </form> </a>
                                </div>
                            </div>
                        </li>   
                    @endauth
    ...
    <div class="bravo-menu-mobile fadeInUp animated3 delay1 selected" style="display:none;">
        ...
        <div class="g-menu">
            <ul class="main-menu menu-generated">
                ...
                @guest
                <li class="{{ Request::is('agent/login') ? 'active' : '' }}">
                    <a href="{{route('agent.login')}}" class="login">
                        Login
                    </a>
                </li>
                @endif
                @auth
                    <li class="depth-0">
                        <a class="dropdown-item" href="javascript:;" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" > @lang('agent.logout') <form id="logout-form" action="{{ route('agent.logout') }}" method="POST" style="display: none;">@csrf </form> </a>
                    </li>
                @endauth
            </ul>
        </div>
