...
@section('title', " ".trans('menu.sidebar.users.admin.create_new_company')." - " .app_name(). " :: Admin")
@section('content')
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">{{trans('menu.sidebar.users.admin.create_new_company')}}</li>
    </ol>
</section>
<section class="content">
    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">{{trans('users::menu.sidebar.add_new_company')}} </h3>
        </div>
        {!! Form::open(['route' => 'company.store','class'=>'','id'=>'validateForm','files'=>true]) !!}
        <div class="box-body">
