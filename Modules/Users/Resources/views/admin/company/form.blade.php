<div class="row">
    <div class="col-sm-6">
        <div class="form-group ermsg">
            <label class=" control-label">{{trans('Company Name')}} <span class="asterisk">*</span></label>
                 {{ Form::text('name',null, ['required','class'=>'form-control','id'=>'name','placeholder'=>'Company name','title'=>trans('menu.validiation.please_enter_name'),'maxlength'=>'50','data-msg-maxlength'=>trans('menu.validiation.name_may_not_be_greater')]) }}
        </div>
    </div>
    <div class="col-sm-6">
        <div class="form-group ermsg">
