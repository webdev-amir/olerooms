...
@section('title', " ".trans('menu.sidebar.agent.main')." ".trans('menu.pipe')." " .app_name(). " ".trans('menu.pipe').trans('menu.admin'))
@section('content')
<section class="content-header">
    <h1><i class="{{trans('users::menu.font_icon')}} "></i>
        {{trans('menu.sidebar.agent.main')}}
        <small></small>
    </h1>
    <ol class="breadcrumb">
        <li><i class="fa fa-dashboard"></i> <a href="{{route('backend.dashboard')}}">{{trans('menu.sidebar.dashboard')}}</a></li>
        <li class="active">{{trans('menu.sidebar.users.agent_main')}}</li>
        <li class="active">{{trans('menu.sidebar.agent.main')}}</li>
    </ol>
</section>
<section class="content">
    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">@lang('Agent')</h3>
            <div class="box-tools pull-right">

                <a href="{{route('agent.create')}}" class="btn btn-success btn-sm pull-right "><i class="fa fa-plus"></i> Add @lang('Agent')</a>
                <br />
            </div>
            ...
            <div class="row" style="float:right;">
                ...
                <div class='col-md-2'>
                    <a href="{{route('agent.index')}}" class="btn btn-success btn-flat pull-left btn-edit-booking-save" title="@lang('users::menu.sidebar.form.search')">
            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="">
                            @if($user->status==0)
                            <a data-placement="top" data-toggle="tooltip" class="danger tooltips" title="Active" rel="Active" name="{{route('agent.status',$user->slug)}}" href="javascript:;" onClick="return AjaxActionTableDrow(this);" data-title="Active" data-action="{{route('agent.status',$user->slug)}}" data-refresh="no" data-reload="yes"><i class="fa fa-check" aria-hidden="true"></i></a>
                            @else
                            <a data-toggle="tooltip" class="success tooltips" title="Inactive" rel="Inactive" name="{{route('agent.status',$user->slug)}}" href="javascript:;" data-placement="top" onClick="return AjaxActionTableDrow(this);" data-title="Inative" data-action="{{route('agent.status',$user->slug)}}" data-refresh="no" data-reload="yes"><i class="fa fa-ban" aria-hidden="true"></i></a>
                            @endif
                            <a href="{{route('agent.show',$user->slug)}}" class="bookingAction" data-toggle="tooltip" data-placement="top" title="View Details">
                                <i class="fa fa-eye"></i>
                            </a>
                            <a href="{{ route('agent.edit',[$user->slug]) }}" class="" data-toggle="tooltip" data-placement="top" title="Edit">
                                <i class="fa fa-pencil"></i>
                            </a>
                            <a data-toggle="tooltip" class="changestatus" title="Delete" href="javascript:;" data-default="Delete" data-title="Delete" data-url="{{ route('agent.delete', $user->id) }}"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
