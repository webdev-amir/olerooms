...
<div class="row">
    <div class="col-sm-12">
        <div class="form-group ermsg">
            <label class=" control-label">{{trans('Address')}} <span class="asterisk">*</span></label>
                 {{ Form::text('address',null, ['required','class'=>'form-control','id'=>'address','placeholder'=>'Address','title'=>'Please enter address','maxlength'=>'255','data-msg-maxlength'=>'Address may not be greater 255 characters.']) }}
        </div>
    </div>
</div>
<div class="row">
     <div class="col-sm-6">
        <div class="form-group ermsg">
            <label class="control-label">{{trans('users::menu.sidebar.form.phone')}} <span class="asterisk">*</span></label>
             {{ Form::text('phone',null, ['required','class'=>'form-control isinteger','id'=>'phone','placeholder'=>trans('users::menu.sidebar.form.phone'),'title'=>'Please enter phone','maxlength'=>'10']) }} 
        </div>
    </div>
     <div class="col-sm-6">
        <div class="form-group ermsg">
    ...
    <div class="col-sm-6">
        <div class="form-group ermsg">
            <label class=" control-label">{{trans('Gender')}} </label>
                {!!Form::select('gender',['male' => 'Male', 'female' => 'Female','other'=>'Other'] , null, ['placeholder'=>'Select gender', 'title'=>'Please select gender', 'class' => 'form-control', 'required' ])!!}
        </div>
    </div>
    <div class="col-sm-6">
        <div class="form-group ermsg">
            <label class=" control-label">{{trans('Marital Status')}} </label>
                {!!Form::select('marital_status',['unmarried' => 'Unmarried', 'married' => 'Married'] , null, ['placeholder'=>'Select marital status', 'title'=>'Please select marital status', 'class' => 'form-control', 'required' ])!!}
        </div>
    </div>
</div>
<div class="row">
