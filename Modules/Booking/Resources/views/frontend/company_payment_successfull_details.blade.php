                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12">
                            <div class="leftside_data bookingconfirm_tab">
                                ...
                                <div class="accordion accordionCustom" id="accordionExample">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="col">
                                                                    ...
                                                                    <div class="form-group td-tag d-flex justify-content-between align-items-start">
                                                                        ...
                                                                        <span class="grey w-50 text-left"> {{get_date_week_month_name($bookingDetail->check_out_date) ?? ''}} </span>
                                                                    </div>
                                                                    @endif
                                                        ...
                                                        <div class="form-row d-none d-lg-flex">
                                                            ...
                                                            <div class="col-md-6 ntr">
                                                                ...
                                                                <div class="col">
                                                                    ...
                                                                    @if($bookingDetail->check_out_date)
                                                                    <div class="form-group bio-tag">
                                                                        {{get_date_week_month_name($bookingDetail->check_out_date) ?? ''}}
                                                                    </div>
                                                                    @endif
                                    ...
                                    @if(in_array($bookingDetail->property->propertyType->slug,['hostel-pg','hostel-pg-one-day','guest-hotel']) && $bookingDetail->booked_by =='company')
                                    <div class="card mb-3">
                                                        ...
                                                        <table class="table tableDesign m-0">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th scope="col">Per {{$bookingDetail->property->propertyType->slug=='guest-hotel'? 'Room':'Seat'}} Amount</th>
                                                                    <th scope="col">Total Amount</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                @if(!empty($bookingDetailJsonData->guests_com))
                                                                @foreach($bookingDetailJsonData->guests_com as $key => $guests)
                                                                @if($guests->ac > 0 || $guests->non_ac > 0)
                                                                <tr>
                                                                    ...
                                                                    <td class="check-date">
                                                                        {{numberformatWithCurrency($guests->ac * $guests->ac_price ?? 0) }}
                                                                    </td>
                                                                    @else
                                                                    <td scope="row">
                                                                        NON-AC
                                                                    ...
                                                                    <td class="check-date">
                                                                        {{ numberformatWithCurrency($guests->non_ac * $guests->non_ac_price ?? 0)}}
                                                                    </td>
                                                                    @endif
                                                                </tr>
                                                                @endif
                                    ...
                                    <div class="mT50 text-center">
                                        <a href="{{ route('company.dashboard.mybookings') }}" class="btn customBtn btn-success minw-184"> Go to My Bookings </a>
                                    </div>
                                </div>
                            </div>
                        </div>
