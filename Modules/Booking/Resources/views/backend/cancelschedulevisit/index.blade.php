...
@section('title', " Schedule Visit Cancel Manager ".trans('menu.pipe')." " .app_name(). " ".trans('menu.pipe').trans('menu.admin'))
@section('content')
<section class="content-header">
    <h1><i class="{{trans('$model::menu.font_icon')}}"></i>
        Schedule Visit Cancel Manager
        <small></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{route('backend.dashboard')}}">{{trans('menu.sidebar.dashboard')}}</a></li>
        <li class="active"> Schedule Visit Cancel Manager</li>
    </ol>
</section>
<section class="content">
    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title"> Schedule Visit Cancel Manager</h3>
...
<script>
    ...
    function loadTable() {
        ...
        $('#data_filter').dataTable({
            ...
            order: [0, 'desc'],
            ajax: {
                "url": "{!! route($model.'.cancelschedulevisit.ajax') !!}",
                "type": "POST",
                "data": function(d) {
                    if ($('#username').val() != "") {
