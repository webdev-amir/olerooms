...
@section('title', " ".trans($model.'::menu.sidebar.create')." ".trans('menu.pipe')." " .app_name(). " ".trans('menu.pipe').trans('menu.admin'))
@section('content')
   <section class="content-header">
      ...
      <ol class="breadcrumb">
         ...
         <li><a href="{{route($model.'.index')}}">@lang($model.'::menu.sidebar.main')</a></li>
