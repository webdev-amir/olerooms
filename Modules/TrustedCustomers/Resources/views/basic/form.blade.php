 <div class="panel-body">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8 ermsg">
          ...
          <input type="file" name="files" id="mediaId" accept="image/*" @if(isset($data)) value="{{$data->picture_path}}" @endif onchange="after_logo_select(this.id)"  style="display:none" class="form-control onlyimageupload" data-uploadurl="{{route('trustedcustomers.mediaStore')}}">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8 ermsg">
          {{ Form::text('designation',null, ['required','class'=>'form-control','id'=>'designation','placeholder'=>'Designation','title'=>'Please enter designation','maxlength'=>50]) }}
      </div>
    </div> 
    <div class="form-group">
         <label class="col-sm-2 control-label">Description </label>
         <div class="col-sm-8 ermsg">
            {{ Form::textarea('description',null, ['class'=>'form-control ckeditor','id'=>'ckeditor','placeholder'=>'Description','title'=>'Please enter description','maxlength'=>500]) }}
         </div>
    </div>
    <div class="form-group">
         <label class="col-sm-2 control-label">Rating <span class="asterisk">*</span></label>
         <div class="col-sm-8 ermsg" style="font-size: 2em;">
            <div id="review"></div>
