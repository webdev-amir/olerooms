...
<nav aria-label="breadcrumb" class="mB40">
    <ol class="breadcrumb  bg-transparent p-0">
        ...
        <li class="breadcrumb-item active" aria-current="page" id="propertyType">Hostel/PG (One day)</li>
    </ol>
</nav>
...
<div class="selectproperty_row fadeInUp animated3 delay1 selected">
    ...
    <div class="detail_panel mt-3">
        ...
        <input type="hidden" name="property_type" value="hostel-pg-one-day">
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6 col-lg-4">
                <div class="form-group ermsg">
                    ...
                    {{ Form::text('total_floors',null, ['required','class'=>'form-control isinteger','id'=>'total_floors','data-msg-required'=>'Please enter total floors','placeholder'=>"Total Floors",'autocomplete'=>'off','maxlength'=>2]) }}
                </div>
            </div>
        </div>
        ...
        <div class="accordion roomAccordian" id="accordionExample">
            @include('property::frontend.manageProperty.steps.create.step2includes.add_property_room_types', ['incCofigRoomTypeArray'=> config('custom.hostelpg_room_types'),'amountTenure'=>'day'])
        </div>
