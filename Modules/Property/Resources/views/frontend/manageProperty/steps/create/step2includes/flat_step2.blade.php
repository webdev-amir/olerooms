...
<nav aria-label="breadcrumb" class="mB40">
    <ol class="breadcrumb  bg-transparent p-0">
        ...
        <li class="breadcrumb-item active" aria-current="page" id="propertyType">Flat</li>
    </ol>
</nav>
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6 col-lg-6">
                <div class="form-group ermsg">
                    ...
                    {{ Form::text('amount',null, ['required','class'=>'form-control numberonly','id'=>'amount','data-msg-required'=>'Please enter amount per month','maxlength'=>'12','data-msg-maxlength'=>'','pattern'=>"\d*",'placeholder'=>"Amount Per Month",'autocomplete'=>'off']) }}
            ...
            <div class="col-sm-12 col-md-6 col-lg-6">
                <div class="form-group ermsg">
                    ...
                    {{ Form::text('security_deposit_amount',null, ['required','class'=>'form-control numberonly','id'=>'security_deposit_amount','data-msg-required'=>'Please enter security deposit amount','maxlength'=>'12','data-msg-maxlength'=>'','pattern'=>"\d*",'placeholder'=>"Security Deposit Amount",'autocomplete'=>'off']) }}
                </div>
            </div>
            <div class="col-sm-12 col-md-6 col-lg-6">
                <div class="form-group ermsg">
            ...
            <div class="col-sm-12 col-md-6 col-lg-6">
                <div class="form-group ermsg">
                    ...
                    {{ Form::text('carpet_area',null, ['required','class'=>'form-control numberonly','id'=>'carpet_area','data-msg-required'=>'Please enter carpet area (in sq)','maxlength'=>'12','data-msg-maxlength'=>'','pattern'=>"\d*",'placeholder'=>"Carpet Area (in Sq)",'autocomplete'=>'off']) }}
                </div>
            </div>
...
<div class="btnrow_progress pb-0">
    ...
    <div class="d-flex justify-content-between">
        ...
        <!-- <button class="btn customBtn btn-success minw-184 directSubmit" id="AddSecondSteps" type="submit" data-loader="Saving Property Informations">@lang('Continue')</button> -->
    </div>
</div>
{!! Form::close() !!}