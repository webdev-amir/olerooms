...
<nav aria-label="breadcrumb" class="mB40">
    <ol class="breadcrumb  bg-transparent p-0">
        ...
        <li class="breadcrumb-item active" aria-current="page" id="propertyType">Guest/Hotel</li>
    </ol>
</nav>
...
<div class="selectproperty_row fadeInUp animated3 delay1 selected">
    <div class="detail_panel mt-3">
        ...
        <div class="accordion roomAccordian" id="accordionExample">
            @include('property::frontend.manageProperty.steps.create.step2includes.add_property_room_types', ['incCofigRoomTypeArray'=> config('custom.hotel_room_types'),'amountTenure'=>'day'])
        </div>
