...
<div class="selectproperty_row fadeInUp animated3 delay1 selected">
    <div class="detail_panel mt-3">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-6 col-lg-4">
                <div class="form-group ermsg">
                    ...
                    {{ Form::text('total_seats',$formData->total_seats, ['required','class'=>'form-control isinteger','id'=>'total_seats','data-msg-required'=>'Please enter total seats','placeholder'=>"Total Seats",'autocomplete'=>'off','maxlength'=>4]) }}
                </div>
            </div>
            <div class="col-sm-12 col-md-6 col-lg-4">
                <div class="form-group ermsg">
                    <label>Available Seats</label>
                    {{ Form::text('rented_seats',$formData->rented_seats, ['required','class'=>'form-control isinteger','id'=>'rented_seats','data-msg-required'=>'Please enter available seats','placeholder'=>"Available Seats",'autocomplete'=>'off','maxlength'=>4]) }}
                </div>
            </div>
            <div class="col-sm-12 col-md-6 col-lg-4">
                <div class="form-group ermsg">
                    <label>Total Floors</label>
                    {{ Form::text('total_floors',$formData->total_floors, ['required','class'=>'form-control isinteger','id'=>'total_floors','data-msg-required'=>'Please enter total floor','placeholder'=>"Total Floors",'autocomplete'=>'off','maxlength'=>2]) }}
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-12 col-md-6 col-lg-6">
                <div class="form-group ermsg">
                    ...
                    {{ Form::text('property_name',$formData->property_name, ['required','class'=>'form-control','id'=>'property_name','data-msg-required'=>'Please enter property name','placeholder'=>"Ex. Blue Beds Hostel",'autocomplete'=>'off']) }}
                </div>
            </div>
            <div class="col-sm-12 col-md-6 col-lg-6">
                <div class="form-group ermsg">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-6 col-lg-6">
                <div class="form-group ermsg">
                    ...
                    {{ Form::text('security_deposit_amount',$formData->security_deposit_amount, ['required','class'=>'form-control isinteger','id'=>'security_deposit_amount','data-msg-required'=>'Please enter security deposit amount','maxlength'=>'12','data-msg-maxlength'=>'','pattern'=>"\d*",'placeholder'=>"Security Deposit Amount",'autocomplete'=>'off']) }}
                </div>
            </div>
        ...
        <div class="accordion roomAccordian" id="accordionExample">
            @include('property::frontend.manageProperty.steps.edit.step2includes.edit_property_room_type', ['incCofigRoomTypeArray'=> config('custom.hostelpg_room_types'),'amountTenure'=>'month'])
        </div>
