...
<div class="selectproperty_row fadeInUp animated3 delay1 selected">
    <div class="detail_panel mt-3">
        ...
        <div class="accordion roomAccordian" id="accordionExample">
            @include('property::frontend.manageProperty.steps.edit.step2includes.edit_property_room_type', ['incCofigRoomTypeArray'=> config('custom.hostelpg_room_types'),'amountTenure'=>'day'])
        </div>
