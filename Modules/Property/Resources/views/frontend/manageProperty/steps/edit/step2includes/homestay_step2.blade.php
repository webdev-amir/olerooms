                ...
                <div class="radiobuttonRow d-flex align-items-center h-100">
                    <div class="d-flex align-items-center">
                        <div class="form-check p-0 mr-4">
                            <input class="mr-2" type="radio" name="is_homestay_ac" id="upi1" value="1" {{@$formData->is_homestay_ac == 1 ?'checked':'' }}>
                            <label for="upi1" class="mb0 font18 medium"> AC </label>
                        </div>
                        <div class="form-check p-0 mr-4">
                            <input class="mr-2" type="radio" name="is_homestay_ac" id="upi" value="0" {{@$formData->is_homestay_ac == 1 ? '':'checked' }}>
