...
class StorePropertySessionRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        if ($this->request->get('step') == 1) {
            ...
            return [
                ...
                //'electricity_bill'        => 'required|max:100',
                'user_id'                 => 'required',
                'upload_selfie'        => 'required|max:100',
                'upload_agreement'        => 'required|max:100',
            ];
    ...
    public function withValidator(Validator $validator)
    {
        ...
        $validator->after(
            function ($validator) use ($step, $total_room_rented, $property_type_id, $total_room_total) {
                if ($step == 2 && in_array($property_type_id, ['guest-hotel', 'hostel-pg', 'hostel-pg-one-day'])) {
