...
class RozarPayCompanyPaymentRepository implements RozarPayPaymentRepositoryInterface
{
    ...
    public function makeBookingPaymentWithRozarPayResponse($request)
    {
        if (config('paymentsetting.razarpay_webhook_enable')) {
            ...
            if ($saved) {
                ...
                return redirect()->to($order->getBookingPaymentSuccessDetailUrlCompany());
            } else {
