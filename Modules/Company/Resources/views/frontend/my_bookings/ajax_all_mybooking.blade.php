<table class="table tableDesign m-0">
   ...
   <tbody>
      ...
      <tr>
         ...
         <td class="check-date">
            <p>{{numberformatWithCurrency($recordList->total)}} </p>
         </td>
         ...
         <td class="text-center">
            <div class="dropdown">
               ...
               <ul class="dropdown-menu bookdrop">
                  <a href="{{route('company.dashboard.mybookings.details',[$recordList->slug])}}">
                     <li><img src="{{asset('images/view.png')}}" class="view-icon">View Booking</li>
                  </a>
                  <a class="myproperty_modal_review" href="javascript:;" data-toggle="modal" data-property-id="{{$recordList->Property->id}}" data-booking-id="{{$recordList->id}}" data-target="#reviewProperty" data-url="{{route('company.get.review-details')}}">
