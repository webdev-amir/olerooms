<ul class="profile-section align-items-center">
   ...
   <li class=" depth-0 copycodeblock">
      <p class="mb-0 font18 d-flex align-items-center mycoupon_code"> My Booking Code:<span class="green ml-2">#<span id="cpcode">{{strtoupper(auth()->user()->company_code)}}</span></span>
