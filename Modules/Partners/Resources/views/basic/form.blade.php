 <div class="panel-body">
   ...
   <div class="form-group">
     ...
     <div class="col-sm-8 ermsg">
       ...
       <input type="file" name="files" id="mediaId" accept="image/*" @if(isset($data)) value="{{$data->picture_path}}" @endif onchange="after_logo_select(this.id)" style="display:none" class="form-control onlyimageupload" data-uploadurl="{{route('partners.mediaStore')}}">
       ...
       <div class="description"><small>Max 5Mb image size allowed. Allowed types : jpeg, jpg. [Size Must be (420x120)]</small></div>
     </div>
