...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="no-js" style="display: block;">
    <head>
     ...
     <body class="frontend-page header-normal {{addDarkClass()}}">
        <div class="bravo_wrap property_owner" id="app">
            @include('includes.loader')
            @include('propertyownerdashboard::includes.header')
            @yield('content')
            @include('includes.footer')
        </div>
        @include('admin.page.message')
        <script src="{{asset('js/frontend.js')}}" defer></script><script src="{{URL::to('js/frontend/jquery-ui.js')}}"></script>
        ...
        <script type="text/javascript">
            ...
            var pdf_file_path = "{{URL::to('img/pdf_file_image.png')}}";
        ...
        <!-- <script src="{{URL::to('theme/libs/bootbox/bootbox.min.js')}}"></script> -->
        ...
        <!-- <script src="{{URL::to('theme/libs/select2/js/select2.min.js')}}"></script> -->
        <!-- <script src="{{URL::to('theme/js/functionse438.js?_ver=2.1.0')}}"></script> -->
        <!-- <script src="{{URL::to('theme/libs/pusher.min.js')}}"></script> -->
       <!--  <script src="{{URL::to('theme/js/olerooms.js?_ver=2.1.0')}}"></script> -->
        <!-- <script type="text/javascript" src="{{URL::to('theme/js/ion.rangeSlider.min.js')}}"></script> -->
        <!-- <script type="text/javascript" src="{{URL::to('theme/js/care438.js?_ver=2.1.0')}}"></script> -->
