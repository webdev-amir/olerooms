            ...
            <div class="header-left">
              <div class="bravo-menu">
                 <ul class="main-menu menu-generated">
                    @auth
                        @if(auth()->user()->hasRole('vendor'))
                            <li class=" depth-0 {{ Request::is('propertyowner') ? 'active' : '' }}">
                               ...
                               <span class="icondesign"><img src="{{URL::to('images/call-owner.svg')}}" alt="image"/></span>
                               List Your Property
                               </a>
                            </li>
                        @else
                    ...
                    @endauth
                    <li class=" depth-0">
                       <a href="javascript:;" class="border-0" style="text-transform:none ;">
						...
						<li class="depth-0">
							<div class="dropdown afterloginMenu ml-3 position-relative ">
								...
								<div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
									...
									@endif
									<a class="dropdown-item" href="{{ route('owner.logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" > @lang('menu.logout') <form id="logout-form" action="{{ route('owner.logout') }}" method="POST" style="display: none;">@csrf </form> </a>
								</div>
							</div>
						</li>	
					@endauth
    ...
    <div class="bravo-menu-mobile fadeInUp animated3 delay1 selected" style="display:none;">
        ...
        <div class="g-menu">
            <ul class="main-menu menu-generated">
                ...
                @guest
                <li class="{{ Request::is('owner/login') ? 'active' : '' }}">
                ...
                @auth
                    <li class="depth-0">
                        <a class="dropdown-item" href="{{ route('owner.logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" > @lang('menu.logout') <form id="logout-form" action="{{ route('auth.logout') }}" method="POST" style="display: none;">@csrf </form> </a>
                    </li>
                @endauth
            </ul>
        </div>
