                  ...
                  <div class="dash_header d-flex justify-content-between">
                     <div aria-label="breadcrumb" class="breadcrumb-page-bar">
                        <ul class="page-breadcrumb p-0">
                           <li class="breadcrumb-item"><a href="{{route('vendor.dashboard.myvisits')}}"> My Visits </a></li>
                     ...
                     <div class="inner_content w-100">
                        <div class="details-table">
                           <div class="details-heading">
                              ...
                              <div class="icon_wrap_new">

                                 <img style="cursor: pointer;" class="hidden-print" onclick="window.print()" src="{{URL::to('images/print.svg')}}">
                              </div>
                           </div>
                        </div>
                        @if(isset($data->scheduleVisitPropertyForVendor))
                        @foreach($data->scheduleVisitPropertyForVendor as $key => $propertyList)
                        <div class="accordin-first olddesign_accordien">
                           <div class="row">
                              <div class="col-md-12">
                                 <div class="open-tag">
                                    <a class="details-accordin vist-open" data-toggle="collapse" href="#collapseExample{{$key}}" role="button" aria-expanded="false">
                                       <span class="create-span">{{$key+1}}</span>{{$propertyList->property->property_name}} ({{$propertyList->property->property_code}})
                                    </a>
                                                      ...
                                                      <div class="form-group ">
                                                         <div class="complete-detail">
                                                            ...
                                                            <div class="click-tag mt-3">
                                                               ...
                                                               <p><a><img src="{{$amenity->amenities->PicturePath}}" class="details-img" onerror="this.src='{{onerrorReturnImage()}}'">{{$amenity->amenities->name}}</a></p>
                                                               @endforeach
                                                            </div>
                                                            <div class="col-8 p-0">
                                                               <div class="owner-confilg">
                                                                  <p>Convinient time to visit property:</p>
                                                                  <p>
                        ...
                        <div class="accordin-first olddesign_accordien">
                           <div class="row">
                              <div class="col-md-12">
                                 <div class="open-tag">
                                    <p class="mb-0 pt-0">
                                       <a class="details-accordin d-inline-block" data-toggle="collapse" href="#collapseCustomerDetails" role="button" aria-expanded="false" aria-controls="collapseCustomerDetails">
                                          Customer Details
                                       </a>
                                       ...
                                       <div class="card card-body">
                                          ...
                                          <div class="form-row d-none d-lg-flex">
                                             <div class="col-md-6 right-border ntr">
                                                <div class="col">
                                                   <!--<img src="{{URL::to('images/detail-profile.png')}}">-->
                                                   <img src="{{$data->customer->PicturePath}}" alt="proimg" onerror="this.src='{{$data->customer->ErrorPicturePath}}'" width="100px" height="100px" />
