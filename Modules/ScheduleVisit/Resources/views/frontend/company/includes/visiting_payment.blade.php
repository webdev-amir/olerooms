<div class="row justify-content-center">
    <div class="col-sm-12 col-md-12 col-lg-8">
        <form action="{{ route('company.booking.payment') }}" method="post" id="addPaymentForm">
        @csrf
            ...
            <button class="btn btn-success btndefault customBtn mt-4 mb-4 w-100" type="button" id="addPaymentButton">Make Payment of  {{numberformatWithCurrency(setting_item('schedule_visit_amount'))}}</button>
        </form>
    </div>
</div>