<div class="row">
	<div class="col-sm-12 col-md-12 col-lg-8">
		<div class="leftside_data">
			{!! Form::open(['route' => 'company.schedulevisit.update','id'=>'F_UpdateToSchedule','autocomplete'=> 'off']) !!}
				...
				<div class="card border-0 mb-3">
					<div class="card-header p-0" id="heading{{$key}}">
						<h2 class="mb-0">
							...
							<div class="visit-property loading visit-remove-icon" data-id="{{$val->id}}" data-url="{{ route('company.schedulevisit.delete')}}">
					...
					<div id="collapse{{$key}}" class="collapse show" aria-labelledby="heading{{$key}}">
						<div class="card-body">
							...
							<div class="row mt-3">
								...
								<div class="col-sm-12 col-md-6">
									<div class="form-group selecticon mb-0">
