...
@section('title', " Schedule Visit Details ".trans('menu.pipe')." " .app_name(). " ".trans('menu.pipe').trans('menu.admin'))
@section('content')
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{route('adminschedulevisit.index')}}">Schedule Visit Managment</a></li>
        <li class="active">Schedule Visit Details</li>
    </ol>
</section>
