...
<head>
    ...
    <script>
        var bookingCore = {
            ...
            view_visit_checkin_date_formate: 'YYYY-MM-DD',
            date_time_format: 'MM/DD/YYYY hh:mm A',
            map_provider: 'gmap',
            map_gmap_key: '',
            routes: {
                login: "{{route('customer.login')}}",
                login_mobile: "{{route('customer.login.mobile')}}",
...
<body class="frontend-page header-normal {{addDarkClass()}}">
    <div class="bravo_wrap {{checkRoleUsingSegment()}}_corporate" id="app">
        @include('includes.loader')
        @if(Route::currentRouteName() != 'manageProperty.success')
        ...
        <div class="modal fade " id="bookingOptions" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content relative modal_design">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="font-size: 14px">
                    Close <span aria-hidden="true" > &times;</span>
                    </button>
                    <div class="modal-body text-center p-0">
                        <h4 class="font24 black medium mb-3">Book Property</h4>
                        <p class="font16 grey regular">
                            Book property as a : -
                        </p>
                        <div class="d-flex justify-content-center mt-3">
                            <a href="" class="outlineBtn_green minw-101 mx-2 myBookingButton" data-id="" data-action="" id="customerRoute">Customer</a>
                            <a href="" class="outlineBtn_green minw-101 mx-2 myBookingButton" data-id="" data-action="" id="companyRoute">Company</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal fade " id="scheduleOptions" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content relative modal_design">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="font-size: 14px">
                    Close <span aria-hidden="true" > &times;</span>
                    ...
                    <div class="modal-body text-center p-0">
                        <h4 class="font24 black medium mb-3">Schedule Property</h4>
                        <p class="font16 grey regular">
                            Schedule property as a : -
                        </p>
                        <div class="d-flex justify-content-center mt-3">
                            <button class="outlineBtn_green minw-101 mx-2 store-visit" id="scheduleCustomerRoute" data-url="" data-id="">Customer</button>
                            <button class="outlineBtn_green minw-101 mx-2  store-visit-company" id="scheduleCompanyRoute" data-url="" data-id="">Company</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript">
        ...
        var _currentRname = "@if(request()->route()) {{ request()->route()->getName() }} @else "
        " @endif ";
        var _SliderCoountForTrust = {!!getSliderCountForTrust() !!};
        var _SliderCityIsLoop = "{{isCityLoopTrueFalse()}}";
    ...
    <script type="text/javascript" src="{{URL::to('theme/js/event438.js')}}"></script>
    <script>
        window.trans = <?php
