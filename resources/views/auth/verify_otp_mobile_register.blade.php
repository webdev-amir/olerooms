            ...
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-6  fadeInUp animated1 selected">
                    ...
                    <div class="customForm">
                        <form method="POST" class="directSubmit" action="{{route('customer.MobileVerify.OTP')}}" id="F_cotpverify">
                            @csrf
                            ...
                            <div class="form-group d-flex justify-content-between align-items-center mb-0 mT30 ermsg">
                                ...
                                <button type="submit" id="cotpverify" class="btn customBtn btn-success minw-184 form-submit directSubmit"> Submit OTP </button>
                            </div>
                        </form>
                    </div>
                </div>
                <div class="col-sm-12 col-md-12 col-lg-6">
                    <div class="authContent">
                        <div class="fadeInUp animated1 selected">
                            <h4 class="green mb-4">Enter <span class="d-block black">OTP Verification
                                </span></h4>
