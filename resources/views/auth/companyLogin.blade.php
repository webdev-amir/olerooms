            ...
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-6  fadeInUp animated1 selected">
                    ...
                    <div class="tab-content" id="myTabContent">
                                <form method="POST"  action="{{route('company.login')}}" id="F_loginCompany" autocomplete="off">
                                @csrf
                                ...
                                <div class="customForm mT30">
                                    ...
                                    <div class="form-group text-right mb-0  mt-4 d-flex justify-content-between align-items-center">
                                        <a href="{{ route('company.password.request') }}" class="grey font16 regular text-decoration-underline"> Forgot Password? </a>
                                        <button type="submit" id="loginCompany" class="btn customBtn btn-success minw-101 form-submit directSubmit" data-loader="Please wait, Logging to your account."> Login </button>
                                    </div>
                                </div>
                            </form>
                    </div>
